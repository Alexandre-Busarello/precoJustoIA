...
all 8 stock models, named screening presets (from screening-presets.ts), and advanced filters (sector, market cap size).
...
- **WHEN** user selects "Small Cap" (< R$2B) with "Ações" active
