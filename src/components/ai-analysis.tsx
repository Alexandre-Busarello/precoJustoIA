...
import { Loader2, Brain, Sparkles, AlertCircle, CheckCircle2 } from 'lucide-react'
        ...
        {!analysis && !isLoading && (
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              ...
              indicadores fundamentalistas e informações recentes da internet.
            </p>
            <Button 
        ...
        {isLoading && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              Nossa IA está analisando {name} e buscando informações recentes na internet. 
