...
/**
 * CTA exibido quando usuário anônimo atinge o limite de 2 visualizações gratuitas.
 * Convida a criar conta para ganhar 1 dia de acesso completo com TRIAL.
 */
