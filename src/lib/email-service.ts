        ...
        <div class="email-wrapper">
          <div class="container">
            ...
            <div class="content">
              ...
              <p class="main-text">
                Infelizmente, não conseguimos processar o pagamento da sua assinatura Premium no <strong>Preço Justo AI</strong>. 
              ...
              <p class="main-text">
                <strong>Não perca a oportunidade!</strong> Sua assinatura Premium te dará acesso a análises avançadas, 
                estratégias exclusivas e ferramentas profissionais para maximizar seus investimentos.
              </p>
            </div>
