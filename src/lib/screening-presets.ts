...
export const SCREENING_PRESETS: Record<ScreeningPresetSlug, ScreeningPreset> = {
  ...
  'top-vacas-leiteiras-dividendos': {
    ...
    hook: 'Esqueça a poupança. Nossa IA selecionou estas 3 empresas que são as verdadeiras "Vacas Leiteiras" da bolsa agora, pagando dividendos gordos. Veja o Yield da primeira da lista...',
